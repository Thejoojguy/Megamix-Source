...
class ModMenuState extends MusicBeatState
{
	...
	var grpWeekCharacters:FlxTypedGroup<MenuCharacterMod>;
	...
	override function create()
	{
		...
		grpWeekCharacters = new FlxTypedGroup<MenuCharacterMod>();
		...
		for (char in 0...3)
		{
			var weekCharacterThing:MenuCharacterMod = new MenuCharacterMod((FlxG.width * 0.25) * (1 + char) - 150, weekCharacters[curWeek][char]);
